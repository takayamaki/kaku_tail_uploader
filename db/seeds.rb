if Rails.env.development?
  ...
  User.where(name: 'kakutail-host').first_or_create(name: 'kakutail-host',email: "kakutail-host@localhost", password: 'kakutail-host', password_confirmation: 'kakutail-host', confirmed_at: Time.now.utc, role: :host)
